...
@section('title', 'List Approved PR')
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title"> List Approved PR </h3>
    ...
    $(document).ready(function(){
        ...
        function loadDocument(_params){
            $("#tbl-budget-list").DataTable({
                serverSide: true,
                ajax: {
                    url: base_url+'/proc/pr/approvedprintlist'+_params,
                    data: function (data) {
                        data.params = {
                            sac: "sac"
                        }
            ...
            $('#tbl-budget-list tbody').on( 'click', '.button-change', function () {
                ...
                selected_data = [];
                selected_data = table.row($(this).closest('tr')).data();
                window.location = "/proc/pr/changeapprovedpr/"+selected_data.id;
            });
        }
