...
@section('title', 'Pembuatan Price Comparison / Quotation')
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Pembuatan Price Comparison / Quotation</h3>
                        <div class="card-tools">
                            <button type="submit" class="btn btn-primary btn-sm btn-save-pr">
                                <i class="fas fa-save"></i> Simpan Quotation
                            </button>
                                ...
                                <div class="row">
                                    <div class="col-lg-12 col-md-12">
                                        <div class="form-group">
                                            <label for="tglreq">Tanggal Quotation</label>
