...
@section('title', 'List Approve PBJ')
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">List Approve PBJ</h3>
...
<script>
    ...
    $(document).ready(function(){
        $("#tbl-pbj-list").DataTable({
            serverSide: true,
            ajax: {
                url: base_url+'/approve/pbj/approvelist',
                data: function (data) {
                    data.params = {
                        sac: "sac"
                    }
            ...
            columns: [
                ...
                {"defaultContent": 
                    `
                    <button class='btn btn-success btn-sm button-approve-budget'> <i class='fa fa-search'></i> VIEW</button>
                    `,
        ...
        $('#tbl-pbj-list tbody').on( 'click', '.button-approve-budget', function () {
