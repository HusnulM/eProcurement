...
@section('title', 'Upload Master Vendor')
    ...
    <div class="col-lg-12 mt-2">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Upload Master Vendor</h3>
                <div class="card-tools">
                    <!-- <button type="button" class="btn btn-tool" data-card-widget="collapse" title="Collapse">
                        <i class="fas fa-minus"></i>
                    </button> -->
                    <a href="/excel/Template Master Vendor.xlsx" target="_blank" class="btn btn-primary btn-sm"> 
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <form action="{{ url('/master/vendor/upload/save') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-md-10">
