...
@section('title', 'Upload Master Kendaraan')
    ...
    <div class="col-lg-12 mt-2">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Upload Kendaraan</h3>
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <form action="{{ url('/master/kendaraan/upload/save') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-md-10">
