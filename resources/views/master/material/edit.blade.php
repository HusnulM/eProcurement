                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="partnumber" id="partnumber" class="form-control" value="{{ $materialdata->partnumber }}" autocomplete="off">
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-12">
                                        <div class="form-group">
                                            <label for="partname">Part Name</label>
                                            <input type="text" name="partname" id="partname" class="form-control" value="{{ $materialdata->partname }}" autocomplete="off">
                                        </div>
                                    </div>  
                                    <div class="col-lg-6 col-md-12">
                                        <div class="form-group">
