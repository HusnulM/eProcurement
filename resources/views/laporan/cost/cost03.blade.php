...
@section('title', 'Laporan Detail Cost')
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Laporan Detail Cost</h3>
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-12">
                            <form action="{{ url('report/exportcost03') }}" method="post">
                                @csrf
                                <div class="row">
    ...
    $(document).ready(function(){
        ...
        function loadDocument(_params){
            $("#tbl-budget-list").DataTable({
                serverSide: true,
                ajax: {
                    url: base_url+'/report/cost03list'+_params,
                    data: function (data) {
                        data.params = {
                            sac: "sac"
                        }
                ...
                columns: [
                    ...
                    {data: "cheklistnumber", className: 'uid'},
                    ...
                    {data: "unit", className: 'uid'},
                    {data: "nama_project", className: 'uid'},      
                    {data: "unit_price", "sortable": false, 
                        render: function (data, type, row){
                            return ``+ row.unit_price.uprice1 + ``;
                        },
                        "className": "text-right",
                    },
                    {data: "total_price", "sortable": false, 
                        render: function (data, type, row){
                            return ``+ row.total_price.totalprice + ``;
                        },
                        "className": "text-right",
                    }
                ],
                ...
                rowGroup: {
                    ...
                    endRender: function ( rows, group ) {
                        ...
                        return $('<tr>')
                            .append( '<td colspan="14" align="right"><b>Total Cost</b></td>' )
