...
@section('title', 'Laporan Cost Per Kendaraan')
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Laporan Cost Per Kendaraan</h3>
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-12">
                            <form action="{{ url('report/exportcost01') }}" method="post">
                                @csrf
                                <div class="row">
    ...
    $(document).ready(function(){
        ...
        $('.btn-search').on('click', function(){
            ...
            if(nopol == null){
                ...
                // alert('tes')
                var param = '?datefrom='+ $('#datefrom').val() +'&dateto='+ $('#dateto').val()+'&nopol='+$('#find-licenseNumber').val();
            }
            // alert(param)
            loadDocument(param);
        });
        ...
        function loadDocument(_params){
            $("#tbl-budget-list").DataTable({
                serverSide: true,
                ajax: {
                    url: base_url+'/report/cost01list'+_params,
                    data: function (data) {
                        data.params = {
                            sac: "sac"
                        }
